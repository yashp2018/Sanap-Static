          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Near MUHS, Tal. Dindori, Dist. Nashik - 422 004, Maharashtra</p>
              </div>
            </div>
            <div className="rounded-2xl overflow-hidden shadow-elevated border border-border">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d787.7120270786045!2d73.80537810480581!3d20.091827501069236!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bdde9ad99774d5b%3A0xe353cdd2e2d34bc8!2sSanap%20Nursery%20India%20Pvt%20Ltd!5e1!3m2!1sen!2sin!4v1778672086882!5m2!1sen!2sin"
                width="100%"
                height="450"
                style={{ border: 0 }}
                allowFullScreen
                ...
                title="Sanap Hi-Tech Nursery Location"
                className="w-full"
              />
            </div>
            <div className="mt-4 flex justify-end">
              <a
                href="https://maps.google.com/?q=Sanap+Hi-Tech+Nursery+Dindori+Nashik+Maharashtra"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 gradient-cta text-white px-5 py-2.5 rounded-full text-sm font-semibold hover:shadow-elevated transition-all hover:scale-105"
              >
