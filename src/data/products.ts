...
import tomatoAnimesh from "@/assets/vegetables/Animesh(0108).png";
...
export const sampleVarieties: Variety[] = [
  ...
  v("tom-animesh", "Animesh (0108)", "Syngenta", "tomato", "Tomato", "vegetables", "Vegetable Plants", tomatoAryaman, 28, 1.50, 1.40, 1.30, 45000,
  ...
  v("tom-atharva", "Atharva", "Seminis", "tomato", "Tomato", "vegetables", "Vegetable Plants", tomatoAryaman, 28, 1.50, 1.40, 1.30, 40000,
  ...
  v("tom-yogi35", "Yogi-35", "Clause", "tomato", "Tomato", "vegetables", "Vegetable Plants", tomatoAryaman, 28, 1.50, 1.40, 1.30, 35000,
  ...
  v("tom-rishika225", "Rishika 225", "Clause", "tomato", "Tomato", "vegetables", "Vegetable Plants", tomatoAryaman, 28, 1.50, 1.40, 1.30, 30000,
  ...
  v("tom-t1068", "T-1068", "Namdhari", "tomato", "Tomato", "vegetables", "Vegetable Plants", tomatoAryaman, 28, 1.50, 1.40, 1.30, 42000,
  ...
  v("tom-t2174", "T-2174", "Syngenta", "tomato", "Tomato", "vegetables", "Vegetable Plants", tomatoAryaman, 28, 1.50, 1.40, 1.30, 38000,
  ...
  v("tom-t2352", "T-2352", "Bioseeds", "tomato", "Tomato", "vegetables", "Vegetable Plants", tomatoAryaman, 28, 1.50, 1.40, 1.30, 33000,
  ...
  v("tom-t2587", "T-2587", "Nuziveedu", "tomato", "Tomato", "vegetables", "Vegetable Plants", tomatoAryaman, 28, 1.50, 1.40, 1.30, 36000,
  ...
  v("tom-aneesha", "Aneesha", "Chia Tai", "tomato", "Tomato", "vegetables", "Vegetable Plants", tomatoAryaman, 28, 1.50, 1.40, 1.30, 28000,
  ...
  v("tom-kirtiman", "Kirtiman", "Seminis", "tomato", "Tomato", "vegetables", "Vegetable Plants", tomatoAryaman, 28, 1.60, 1.50, 1.40, 32000,
  ...
  v("tom-virang", "Virang", "Seminis", "tomato", "Tomato", "vegetables", "Vegetable Plants", tomatoAryaman, 28, 1.50, 1.40, 1.30, 30000,
  ...
  v("tom-saaho", "Saaho", "Syngenta", "tomato", "Tomato", "vegetables", "Vegetable Plants", tomatoAryaman, 28, 1.50, 1.40, 1.30, 35000,
  ...
  v("tom-bajirao", "Bajirao", "Syngenta", "tomato", "Tomato", "vegetables", "Vegetable Plants", tomatoAryaman, 28, 1.50, 1.40, 1.30, 40000,
  ...
  // ── CHILI (key varieties) ──────────────────────────────────────
  v("chi-armour", "Armour", "BASF", "chili", "Chili", "vegetables", "Vegetable Plants", chilliImg, 28, 1.40, 1.30, 1.20, 45000,
  ...
  v("chi-hph5531", "HPH-5531", "Syngenta", "chili", "Chili", "vegetables", "Vegetable Plants", chilliImg, 28, 1.40, 1.30, 1.20, 40000,
  ...
  v("chi-talwar", "Talwar", "Kalash", "chili", "Chili", "vegetables", "Vegetable Plants", chilliImg, 28, 1.40, 1.30, 1.20, 38000,
  ...
  v("chi-shark1", "Shark-1", "Star Field", "chili", "Chili", "vegetables", "Vegetable Plants", chilliImg, 28, 1.40, 1.30, 1.20, 35000,
  ...
  v("chi-sitaragold", "Sitara Gold", "Seminis", "chili", "Chili", "vegetables", "Vegetable Plants", chilliImg, 28, 1.40, 1.30, 1.20, 30000,
  ...
  v("chi-us917", "US-917", "BASF", "chili", "Chili", "vegetables", "Vegetable Plants", chilliImg, 28, 1.40, 1.30, 1.20, 42000,
  ...
  // ── BITTER GOURD ──────────────────────────────────────────────
  v("bg-b6214", "B 6214", "BASF", "bittergourd", "Bitter Gourd", "vegetables", "Vegetable Plants", bitterGourdImg, 12, 4.50, 4.20, 4.00, 20000,
  ...
  v("bg-rushaan", "Rushaan", "BASF", "bittergourd", "Bitter Gourd", "vegetables", "Vegetable Plants", bitterGourdImg, 12, 4.50, 4.20, 4.00, 18000,
  ...
  // ── BRINJAL ────────────────────────────────────────────────────
  v("brn-comandar", "Comandar", "Ajeet Seeds", "brinjal", "Brinjal", "vegetables", "Vegetable Plants", brinjalImg, 28, 1.20, 1.10, 1.00, 25000,
  ...
  v("brn-bartok", "Bartok", "Enza Zaden", "brinjal", "Brinjal", "vegetables", "Vegetable Plants", brinjalImg, 28, 6.00, 5.50, 5.00, 15000,
  ...
  // ── CABBAGE ────────────────────────────────────────────────────
  v("cab-admiral", "Admiral", "Clause", "cabbage", "Cabbage", "vegetables", "Vegetable Plants", cabbageImg, 28, 0.80, 0.70, 0.60, 50000,
  ...
  v("cab-saint", "Saint", "Seminis", "cabbage", "Cabbage", "vegetables", "Vegetable Plants", cabbageImg, 28, 0.90, 0.80, 0.70, 45000,
  ...
  // ── CAPSICUM ───────────────────────────────────────────────────
  v("cap-asha", "Asha", "Clause", "capsicum", "Capsicum", "vegetables", "Vegetable Plants", capsicumImg, 33, 2.50, 2.30, 2.10, 20000,
  ...
  v("cap-paladin", "Paladin", "Syngenta", "capsicum", "Capsicum", "vegetables", "Vegetable Plants", capsicumImg, 33, 2.50, 2.30, 2.10, 18000,
  ...
  // ── CAULIFLOWER ────────────────────────────────────────────────
  v("cfl-c1522", "C-1522", "Syngenta", "cauliflower", "Cauliflower", "vegetables", "Vegetable Plants", cauliflowerImg, 28, 0.90, 0.80, 0.70, 40000,
  ...
  // ── CUCUMBER ───────────────────────────────────────────────────
  v("cuc-gipsy", "Gipsy", "Pyramid", "cucumber", "Cucumber", "vegetables", "Vegetable Plants", cucumberImg, 12, 2.50, 2.30, 2.10, 25000,
  ...
  // ── WATERMELON ─────────────────────────────────────────────────
  v("wm-bahubali", "Bahubali", "Seminis", "watermelon", "Watermelon", "fruits", "Fruit Plants", watermelonImg, 28, 2.80, 2.60, 2.40, 30000,
  ...
  v("wm-sugarqueen", "Sugar Queen", "Syngenta", "watermelon", "Watermelon", "fruits", "Fruit Plants", sugarQueenImg, 28, 2.80, 2.60, 2.40, 35000,
  ...
  v("wm-max", "Max", "BASF", "watermelon", "Watermelon", "fruits", "Fruit Plants", maxImg, 28, 2.80, 2.60, 2.40, 28000,
  ...
  // ── MARIGOLD ───────────────────────────────────────────────────
  v("mar-edenorange", "Eden Orange", "Pyramid", "marigold", "Marigold", "flowers", "Flower Plants", edenOrangeImg, 28, 3.00, 2.80, 2.60, 40000,
  ...
  v("mar-freshorange", "Fresh Orange", "Namdhari", "marigold", "Marigold", "flowers", "Flower Plants", freshOrangeImg, 28, 3.00, 2.80, 2.60, 35000,
  ...
  // ── PAPAYA ─────────────────────────────────────────────────────
  v("pap-taiwan786", "Taiwan 786", "Known You Seeds", "papaya", "Papaya", "fruits", "Fruit Plants", papayaImg, 45, 16.00, 15.00, 14.00, 10000,
