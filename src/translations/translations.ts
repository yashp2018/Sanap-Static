...
export const translations = {
  en: {
    ...
    newsletterDesc: "Subscribe to our newsletter for the latest updates on new varieties and farming tips.",
    subscribe: "Subscribe",
    ...
    plants: "plants",
    days: "days",
    fromRate: "FROM (15K+ RATE)",
    perPlant: "/plant",
    seasonAvailability: "Season Availability",
    available: "Available",
    ...
    cropMuskmelon: "Muskmelon",
    cropPapaya: "Papaya",
    cropMarigold: "Marigold",
    cropSugarcane: "Sugar Cane",
    cropDrumstick: "Drum Stick",
    ...
    bulkPricing: "Bulk Pricing (per plant)",
    ...
    delivery250km: "250+ km Delivery",
    total: "Total",
    unitPrice: "Unit Price",
    addToCart: "Add to Cart",
    adding: "Adding...",
    enquireWhatsapp: "Enquire on WhatsApp",
    loginRequired: "Login Required to Order",
    createAccount: "Create a free account to place bulk orders",
    loginBtn: "Login",
  ...
  hi: {
    ...
    newsletterDesc: "नई किस्मों और कृषि टिप्स पर नवीनतम अपडेट के लिए हमारे न्यूज़लेटर की सदस्यता लें।",
    subscribe: "सदस्यता लें",
    quickLinks: "त्वरित लिंक",
    ourCrops: "हमारी फसलें",
    ...
    of: "में से",
    noVarietiesFound: "कोई किस्म नहीं मिली",
    tryAdjusting: "फ़िल्टर या खोज शब्द बदलें",
    ...
    fromRate: "से (15K+ दर)",
    perPlant: "/पौधा",
    seasonAvailability: "मौसम उपलब्धता",
    available: "उपलब्ध",
    ...
    bulkPricing: "थोक मूल्य (प्रति पौधा)",
    exFactory: "एक्स-फैक्ट्री",
    rate15k: "15K+ दर",
    rate30k: "30K+ दर",
    quantity: "मात्रा (पौधे)",
    delivery: "डिलीवरी",
    localDelivery: "स्थानीय डिलीवरी",
    delivery250km: "250+ किमी डिलीवरी",
    total: "कुल",
    unitPrice: "इकाई मूल्य",
    addToCart: "कार्ट में जोड़ें",
    adding: "जोड़ा जा रहा है...",
    enquireWhatsapp: "व्हाट्सएप पर पूछें",
    loginRequired: "ऑर्डर के लिए लॉगिन आवश्यक",
    createAccount: "थोक ऑर्डर के लिए मुफ्त खाता बनाएं",
    loginBtn: "लॉगिन",
    registerFree: "मुफ्त रजिस्टर करें",
    features: "विशेषताएं",
    advantages: "लाभ",
    agronomicTips: "कृषि सुझाव",
  ...
  mr: {
    ...
    adminPanel: "एडमिन पॅनल",
    logout: "लॉगआउट",
    cart: "कार्ट",

    // Footer
    stayUpdated: "अपडेट राहा",
    newsletterDesc: "नवीन जाती आणि शेती टिप्सवरील नवीनतम अपडेट्ससाठी आमच्या न्यूजलेटरची सदस्यता घ्या.",
    ...
    // Products Page
    productCatalogue: "उत्पादन सूची",
    selectCategory: "श्रेणी निवडा",
    allCategories: "सर्व श्रेणी",
    allCrops: "सर्व पिके",
    filters: "फिल्टर",
    clearAll: "सर्व साफ करा",
    searchVarieties: "जाती शोधा...",
    regionState: "प्रदेश / राज्य",
    allRegions: "सर्व प्रदेश",
    showing: "दाखवत आहे",
    of: "पैकी",
    noVarietiesFound: "कोणतीही जात सापडली नाही",
    tryAdjusting: "फिल्टर किंवा शोध शब्द बदला",
    clearFilters: "सर्व फिल्टर काढा",
    inStock: "साठा उपलब्ध",
    outOfStock: "साठा संपले",
    minOrder: "किमान ऑर्डर",
    plants: "रोपे",
    days: "दिवस",
    fromRate: "पासून (15K+ दर)",
    perPlant: "/रोप",
    seasonAvailability: "हंगाम उपलब्धता",
    available: "उपलब्ध",
    ...
    bulkPricing: "घाउक किंमत (प्रति रोप)",
    exFactory: "एक्स-फॅक्टरी",
    rate15k: "15K+ दर",
    rate30k: "30K+ दर",
    quantity: "प्रमाण (रोपे)",
    delivery: "डिलिव्हरी",
    localDelivery: "स्थानिक डिलिव्हरी",
    delivery250km: "250+ किमी डिलिव्हरी",
    total: "एकूण",
    unitPrice: "एकक किंमत",
    addToCart: "कार्टमध्ये टाका",
    adding: "टाकत आहे...",
    enquireWhatsapp: "व्हाट्सअॅपवर चौकशी करा",
    loginRequired: "ऑर्डरसाठी लॉगिन आवश्यक",
    createAccount: "घाउक ऑर्डरसाठी मोफत खाते तयार करा",
    loginBtn: "लॉगिन",
    registerFree: "मोफत नोंदणी करा",
    features: "वैशिष्ट्ये",
    advantages: "फायदे",
    agronomicTips: "शेती सल्ला",
